    ...
    <c:choose>
      ...
      <c:when test="${not isTransient}">
        ...
        <ul>
         ...
         <%--  <li class="${activeTab=='MY ORDERS' ? ' active' : ' '}">
            <dsp:a page="/myaccount/learn_Ship.jsp" title="learn_Ship" iclass="atg_store_navAccount">              
              <c:out value="learn_Ship"/>
            </dsp:a>
          </li>  --%>
          <%-- Help link --%>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Storefront/j2ee/store.war/navigation/gadgets/welcome.jsp#1 $$Change: 875535 $ --%>
