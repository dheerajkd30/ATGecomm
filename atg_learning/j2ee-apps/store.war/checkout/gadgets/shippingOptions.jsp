          ...
          <dsp:oparam name="output">
            ...
            <c:forEach var="method" items="${availableShippingMethods}" varStatus="status">
              ...
              <li class="${status.first ? 'first' : ''}${status.last ? 'last' : ''}">
				...
				<c:choose>
                  <c:when  test="${shippingMethod!='Anytime'}">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.1/Storefront/j2ee/store.war/checkout/gadgets/shippingOptions.jsp#1 $$Change: 875535 $--%>